...
class RestaurantOrderManagement:
    def __init__(self, root):
        ...
        def setup_background(self, root):
            ...
            canvas.pack()
            original_image = tk.PhotoImage(file="food.jpeg")
            background_image = original_image.subsample(original_image.width(), original_image.height)
        ...
        def place_order(self):
            ...
            if total_cost > 0:
                ...
                messagebox.showerror("Error", "Please put in an order for the sake of your best interest")
